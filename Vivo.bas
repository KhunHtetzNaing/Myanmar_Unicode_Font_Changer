...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","Unicode.txj") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/Unicode.txj")
	File.Copy(File.DirAssets,"Unicode.txj",File.DirRootExternal & "/Vivo Myanmar Font","Unicode.txj")
	
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","Unicode.itz") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/Unicode.itz")
	File.Copy(File.DirAssets,"Unicode.itz",File.DirRootExternal & "/Vivo Myanmar Font","Unicode.itz")
...
Sub b4_Click
	...
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","Unicode.txj") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/Unicode.txj")
	File.Copy(File.DirAssets,"Unicode.txj",File.DirRootExternal & "/Download/i Theme/Font","Unicode.txj")
	
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","Unicode.itz") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/Unicode.itz")
	File.Copy(File.DirAssets,"Unicode.itz",File.DirRootExternal & "/Download/i Theme/Font","Unicode.itz")
	Try
		Dim i As Intent
		i.Initialize("", "")
