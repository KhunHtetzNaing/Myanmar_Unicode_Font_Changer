...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.myanmarandroidapp.mmunifontchanger.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lw.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 68;BA.debugLine="lw.Text = \"Warning :  Requires ROOT Access!\"";
mostCurrent._lw.setText(BA.ObjectToCharSequence("Warning :  Requires ROOT Access!"));
...
mostCurrent._lw.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 71;BA.debugLine="Activity.AddView(lw,1%x,55dip,100%x,5%y)";
...
mostCurrent._b3.Initialize(mostCurrent.activityBA,"b3");
 //BA.debugLineNum = 102;BA.debugLine="b3.Text = \"Help\"";
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Other [#Root]"));
 //BA.debugLineNum = 112;BA.debugLine="tlb.Color = Colors.rgb(0, 150, 136)";
...
mostCurrent._sm._additem("More App",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"moreapp.png"),(Object)(8));
 //BA.debugLineNum = 129;BA.debugLine="sm.AddItem(\"Help\",LoadBitmap(File.DirAssets,\"abou";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._share.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12.5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 143;BA.debugLine="Banner.Initialize2(\"Banner\",\"ca-app-pub-255068525";
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 179;BA.debugLine="File.Copy(File.DirAssets,\"Unicode.ttf\",File.DirR";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Unicode.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
...
mostCurrent._lw = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Unic";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 652;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer For";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 630;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer F";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Unicode_Font Installer For Android Phones! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Unicode+Font+Changer");
...
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 639;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmar";
