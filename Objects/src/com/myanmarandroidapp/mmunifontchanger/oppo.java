...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.myanmarandroidapp.mmunifontchanger.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"Install ကိုနှိပ်ပြီး Myanmar Unicode(i";
mostCurrent._lb.setText(BA.ObjectToCharSequence("Install ကိုနှိပ်ပြီး Myanmar Unicode(iFont) ကို Install လုပ်ပေးလိုက်ပါ။  Install လုပ်လို့ပြီးရင် Done ကိုသာနှိပ်ပေးပါ။ ပြီးရင်အောက်ပါ Change Font ကိုနှိပ်ပြီး Myanmar Unicode(iFont) ကိုရွေးပေးလိုက်ပါ။ နဂိုမူလဖောင့်ကိုပြန်ထားချင်ရင် Change Font ကိုနှိပ်ပြီး Default ကိုပြန်ရွေးထားနိုင်ပါတယ်။"));
...
mostCurrent._b3.Initialize(mostCurrent.activityBA,"b3");
 //BA.debugLineNum = 56;BA.debugLine="b3.Text = \"Help\"";
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Oppo"));
 //BA.debugLineNum = 66;BA.debugLine="tlb.Color = Colors.rgb(0, 150, 136)";
...
mostCurrent._sm._additem("More App",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"moreapp.png"),(Object)(8));
 //BA.debugLineNum = 83;BA.debugLine="sm.AddItem(\"Help\",LoadBitmap(File.DirAssets,\"abou";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._share.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12.5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 97;BA.debugLine="Banner.Initialize2(\"Banner\",\"ca-app-pub-255068525";
...
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 180;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="File.Copy(File.DirAssets,\"Unicode.apk\",File.DirRo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Unicode.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.apk");
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Unicode.apk");
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 130;BA.debugLine="If File.Exists(File.DirRootExternal,\"Unicode.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="File.Delete(File.DirRootExternal,\"Unicode.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.apk");
 };
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="If File.Exists(File.DirRootExternal,\"Unicode.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 147;BA.debugLine="File.Delete(File.DirRootExternal,\"Unicode.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.apk");
 };
...
public static String  _interstitial_adopened() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub Interstitial_adopened";
 //BA.debugLineNum = 176;BA.debugLine="Log(\"Opened\")";
...
public static String  _interstitial_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub Interstitial_FailedToReceiveAd (ErrorCode As S";
 //BA.debugLineNum = 171;BA.debugLine="Log(\"not Received - \" &\"Error Code: \"&ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("not Received - "+"Error Code: "+_errorcode);
 //BA.debugLineNum = 172;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 173;BA.debugLine="End Sub";
return "";
}
public static String  _interstitial_receivead() throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub Interstitial_ReceiveAd";
 //BA.debugLineNum = 167;BA.debugLine="Log(\"Received\")";
anywheresoftware.b4a.keywords.Common.Log("Received");
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return "";
}
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 222;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 225;BA.debugLine="Sub share_Click";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 228;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer For";
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 231;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 188;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 189;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 190;BA.debugLine="Select Item";
switch (BA.switchObjectToInt(_item,(Object)(1),(Object)(2),(Object)(3),(Object)(4),(Object)(5),(Object)(6),(Object)(7),(Object)(8),(Object)(9))) {
case 0: {
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(Samsung)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._samsung.getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,oppo.getObject());
 break; }
case 2: {
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(Vivo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vivo.getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(Huawei)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._huawei.getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(Xiaomi)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._xiaomi.getObject()));
 break; }
case 5: {
 //BA.debugLineNum = 202;BA.debugLine="StartActivity(Other)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._other.getObject()));
 break; }
case 6: {
 //BA.debugLineNum = 204;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 205;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 206;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer F";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Unicode_Font Installer For Android Phones! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Unicode+Font+Changer");
 //BA.debugLineNum = 207;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 208;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 209;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 210;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 211;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 212;BA.debugLine="StartActivity (ShareIt)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 214;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 215;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmar";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.myanmarandroidapp.com")));
 break; }
case 8: {
 //BA.debugLineNum = 217;BA.debugLine="StartActivity(About)";
