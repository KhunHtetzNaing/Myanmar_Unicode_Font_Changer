...
public class huawei extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.huawei");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.myanmarandroidapp.mmunifontchanger", "com.myanmarandroidapp.mmunifontchanger.huawei");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.myanmarandroidapp.mmunifontchanger.huawei", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"Install  ကိုနှိပ်ပါ။ ပြီးရင်အောက်ပါ Ch";
mostCurrent._lb.setText(BA.ObjectToCharSequence("Install  ကိုနှိပ်ပါ။ ပြီးရင်အောက်ပါ Change Font ကိုနှိပ်ပြီး Myanmar Unicode Font နာမည်နဲ့ Theme ကိုရွေးပေးလိုက်ပါ။ နဂိုမူလဖောင့်ကိုပြန်ထားချင်ရင် Change Font ကိုနှိပ်ပြီး Default ကိုပြန်ရွေးထားနိုင်ပါတယ်။"));
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","Unicode.hwt")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Unicode.hwt");};
 //BA.debugLineNum = 123;BA.debugLine="File.Copy(File.DirAssets,\"Unicode.hwt\",File.DirRo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Unicode.hwt",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","Unicode.hwt");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 221;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer For";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 199;BA.debugLine="copy.setText(\"#Myanmar_Unicode_Font Installer F";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Unicode_Font Installer For Android Phones! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Unicode+Font+Changer");
...
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmar";
