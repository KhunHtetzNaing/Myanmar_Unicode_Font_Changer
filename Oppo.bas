...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "Install ကိုနှိပ်ပြီး Myanmar Unicode(iFont) ကို Install လုပ်ပေးလိုက်ပါ။  Install လုပ်လို့ပြီးရင် Done ကိုသာနှိပ်ပေးပါ။ ပြီးရင်အောက်ပါ Change Font ကိုနှိပ်ပြီး Myanmar Unicode(iFont) ကိုရွေးပေးလိုက်ပါ။ နဂိုမူလဖောင့်ကိုပြန်ထားချင်ရင် Change Font ကိုနှိပ်ပြီး Default ကိုပြန်ရွေးထားနိုင်ပါတယ်။"
...
Sub b1_Click
	ad1.Enabled = True
	File.Copy(File.DirAssets,"Unicode.apk",File.DirRootExternal,"Unicode.apk")
	Msgbox("1. Install Fone App" & CRLF & "2. After Installed click done!" & CRLF & "3. Click Change Font and Choose your Font!","Attention!")
	Dim i As Intent
	i.Initialize(i.ACTION_VIEW,"file:///"&File.DirRootExternal& "/Unicode.apk")
	i.SetType("application/vnd.android.package-archive")
	StartActivity(i)
End Sub

Sub b2_Click
	If File.Exists(File.DirRootExternal,"Unicode.apk") = True Then
		File.Delete(File.DirRootExternal,"Unicode.apk")
	End If
	Try
		Dim i As Intent
		i.Initialize("", "")
