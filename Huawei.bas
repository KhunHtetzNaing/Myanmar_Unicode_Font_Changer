...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "Install  ကိုနှိပ်ပါ။ ပြီးရင်အောက်ပါ Change Font ကိုနှိပ်ပြီး Myanmar Unicode Font နာမည်နဲ့ Theme ကိုရွေးပေးလိုက်ပါ။ နဂိုမူလဖောင့်ကိုပြန်ထားချင်ရင် Change Font ကိုနှိပ်ပြီး Default ကိုပြန်ရွေးထားနိုင်ပါတယ်။"
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Unicode.hwt") = True Then File.Delete(File.DirRootExternal,"Unicode.hwt")
	File.Copy(File.DirAssets,"Unicode.hwt",File.DirRootExternal & "/HWThemes","Unicode.hwt")
